...
Right-click a widget to change its size, edit weather settings or System Monitor temperature units, or exit it. Network rates automatically use B/s, Mbps, or Gbps. Run `widget` in a terminal to see each widget's status and start one that is stopped.
